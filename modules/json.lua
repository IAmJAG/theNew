...
function OBJDEF:unsupportedTypeEncoder(value_of_unsupported_type)
	local typ = typeOf(value_of_unsupported_type)
	if _G[typ] == nil then
		return nil, "Can't encode type " .. typ
	else
		return value_of_unsupported_type:encode(), nil
	end
end
